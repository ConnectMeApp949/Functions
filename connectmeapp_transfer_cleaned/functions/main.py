...
# from test_reqs.test_endpoints import * # REMOVED: exposes all data without auth
from auth.handlers import *
# from seed.handlers import * # REMOVED: seed endpoints should not be in production
from booking.handlers import *
from booking.capture_bookings_daily import captureBookingsDaily
